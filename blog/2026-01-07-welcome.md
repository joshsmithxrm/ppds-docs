...
[Star the repo](https://github.com/joshsmithxrm/power-platform-developer-suite) if you want to follow along. [Check out the docs](/docs/getting-started) to dig deeper. If PPDS saves you time, consider [sponsoring the project](https://github.com/sponsors/joshsmithxrm) or [follow me on GitHub](https://github.com/joshsmithxrm).
